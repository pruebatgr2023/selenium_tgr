...
public class elimina_retenciones_test extends AbsTest {
	...
	public void test() throws Exception {
		...
		driver.findElement(By.xpath(
				"/html[1]/body[1]/table[1]/tbody[1]/tr[1]/td[1]/form[1]/table[9]/tbody[1]/tr[1]/td[1]/div[1]/input[1]"))
				.click();
		waitSleep(3);
		// ingresa OBS
		driver.findElement(By.xpath("//tbody/tr[14]/td[3]/textarea[1]"))
				.sendKeys("Eliminacion por Prueba Automatizada");
		waitSleep(2);
