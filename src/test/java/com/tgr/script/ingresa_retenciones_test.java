...
public class ingresa_retenciones_test extends AbsTest {
	...
	public void test() throws Exception {
		...
		driver.findElement(By.xpath("//select[@id='wlw-select_key:{actionForm.tipoRetencion}']"))
		...
		driver.findElement(By.xpath("//select[@id='wlw-select_key:{actionForm.subtipoRetencion}']"))
				.sendKeys(Keys.ARROW_DOWN);
		driver.findElement(By.xpath("//select[@id='wlw-select_key:{actionForm.subtipoRetencion}']"))
				.sendKeys(Keys.ENTER);
		waitSleep(2);
		...
		driver.findElement(By.xpath("/html/body/table/tbody/tr/td/form/table[3]/tbody/tr[5]/td[3]/input"))
				.sendKeys("1234");
		waitSleep(2);
		capturarPantalla(driver, "paso 8 Retenciones y Compensaciones formulario");
		// se completa fecha
		driver.findElement(By.xpath("/html/body/table/tbody/tr/td/form/table[3]/tbody/tr[5]/td[5]/input[1]"))
				.sendKeys("01");
		driver.findElement(By.xpath("/html/body/table/tbody/tr/td/form/table[3]/tbody/tr[5]/td[5]/input[2]"))
				.sendKeys("01");
		driver.findElement(By.xpath("/html/body/table/tbody/tr/td/form/table[3]/tbody/tr[5]/td[5]/input[3]"))
				.sendKeys("2023");
		waitSleep(2);
		...
		driver.findElement(By.xpath("/html/body/table/tbody/tr/td/form/div/table[1]/tbody/tr[1]/td[3]/input[1]"))
				.sendKeys("1000000");
		waitSleep(2);
		...
		// fecha mandato
		driver.findElement(By.xpath("/html/body/table/tbody/tr/td/form/div/table[1]/tbody/tr[5]/td[3]/input[1]"))
				.sendKeys("01");
		driver.findElement(By.xpath("/html/body/table/tbody/tr/td/form/div/table[1]/tbody/tr[5]/td[3]/input[2]"))
				.sendKeys("01");
		driver.findElement(By.xpath("/html/body/table/tbody/tr/td/form/div/table[1]/tbody/tr[5]/td[3]/input[3]"))
				.sendKeys("2023");
		waitSleep(2);
		capturarPantalla(driver, "paso 13 Retenciones y Compensaciones fecha mandato");
		// rut mandatario
		driver.findElement(By.xpath("/html/body/table/tbody/tr/td/form/div/table[1]/tbody/tr[6]/td[3]/input[1]"))
				.sendKeys("1");
		driver.findElement(By.xpath("/html/body/table/tbody/tr/td/form/div/table[1]/tbody/tr[6]/td[3]/input[2]"))
				.sendKeys("9");
		waitSleep(2);
		capturarPantalla(driver, "paso 14 Retenciones y Compensaciones rut mandatario");
		// ingresa OBS
		driver.findElement(By.xpath("/html/body/table/tbody/tr/td/form/div/table[1]/tbody/tr[7]/td[3]/textarea"))
				.sendKeys("Prueba Automatizada");
		waitSleep(2);
		...
		driver.findElement(
				By.xpath("/html/body/table/tbody/tr/td/form/table[3]/tbody/tr[8]/td[3]/table[1]/tbody/tr/td[2]/select"))
				.click();
		driver.findElement(
				By.xpath("/html/body/table/tbody/tr/td/form/table[3]/tbody/tr[8]/td[3]/table[1]/tbody/tr/td[2]/select"))
				.sendKeys(Keys.ARROW_DOWN);
